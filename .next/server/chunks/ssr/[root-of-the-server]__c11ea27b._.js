...
const firebaseConfig = {
    ...
    "storageBucket": "studio-1311282789-8951d.firebasestorage.app",
    "measurementId": "",
...
const FirebaseProvider = ({ children, firebaseApp, firestore, auth, storage })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, (u)=>setUserAuthState({
                user: u,
                isUserLoading: false,
                userError: null
            }), (e)=>setUserAuthState({
...
const useStorage = ()=>useFirebase().storage;
...
;
;
async function setDocumentNonBlocking(docRef, data, options) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])(docRef, data, options);
    } catch (error) {
...
async function addDocumentNonBlocking(colRef, data) {
    try {
        const docRef = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDoc"])(colRef, data);
        return docRef;
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["errorEmitter"].emit('permission-error', new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
            path: colRef.path,
...
async function updateDocumentNonBlocking(docRef, data) {
    try {
...
async function deleteDocumentNonBlocking(docRef) {
    try {
...
function getSdks(firebaseApp) {
    ...
    return {
        ...
        storage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStorage"])(firebaseApp, bucketUrl)
    };
}
;
;
...
__turbopack_context__.s([
    ...
    "firebaseConfig",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["firebaseConfig"],
    "getSdks",
